...
names = ["Luna", "Milo", "Bella", "Simba", "Leo", "Lola", "Max", "Nala", "Oliver", "Chloe"]
...
def generate_cat_data():
    return {
        ...
        "breed_id": random.randint(100, 999)  # Поле с подчеркиванием для соответствия CatDTO
    }
...
for _ in range(NUM_CATS):
    ...
    try:
        ...
        if response.status_code in [200, 201]:
            ...
            print(f"Ошибка при создании кошки {cat_data['name']}: {response.status_code} - {response.text}")
